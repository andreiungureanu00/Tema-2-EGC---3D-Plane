	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
                ...
                glm::mat4 rotateMatrix = glm::rotate(glm::mat4(1.0f), angle, right);
                forward = rotateMatrix * glm::vec4(forward, 1.0);
			...
			void RotateFirstPerson_OY(float angle)
			{
                ...
                glm::mat4 rotateMatrix = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0));
                up = rotateMatrix * glm::vec4(up, 0);
                up = glm::normalize(up);
                forward = rotateMatrix * glm::vec4(forward, 1.0);
                right = glm::cross(forward, up);
